...
- `sequence`
    ...
    - Returns
        - A list consisting of <a href="note.md">Note</a>, <a href="rest.md">Rest</a>, and <a href="chord.md">Chord</a> objects 
...
- `get_notes(seq : list)`
    - Retrieves all the [Note](note.md) objects in the current part
    - Args
...
- `get_rests(seq : list)`
    - Retrieves all the [Rest](rest.md) objects in the current part
    - Args
        - seq: A list consisting of Scopul musical element types (Rest, Note and Chord objects)
    - Returns 
...
- `get_chords(seq : list)`
    - Retrieves all the [Chord](chord.md) objects in the current part
    - Args
        - seq: A list consisting of Scopul musical element types (Rest, Note and Chord objects)
    - Returns 
